...
C xc = w2.dot(xb) + b2
     ...
     +  0.179510131478)
C xsig = w3.dot(xd) + b3
      xsig =-1.147175073624/(1.0 + xc0) +
     +  0.396453082561/(1.0 + xc1) -
     +  1.731730222702/(1.0 + xc2) +
     +  0.341490298510/(1.0 + xc3) +
     +  0.917140424252/(1.0 + xc4) +
     +  0.416720062494/(1.0 + xc5) +
     +  0.469032645226/(1.0 + xc6) -
     +  0.399738907814
C ya = w3v*(xd / (1 + xc)**2)
      ya0 =-1.147175073624*(xc0/(1.0 + xc0)**2)
      ya1 = 0.396453082561*(xc1/(1.0 + xc1)**2)
      ya2 =-1.731730222702*(xc2/(1.0 + xc2)**2)
      ya3 = 0.341490298510*(xc3/(1.0 + xc3)**2)
      ya4 = 0.917140424252*(xc4/(1.0 + xc4)**2)
      ya5 = 0.416720062494*(xc5/(1.0 + xc5)**2)
      ya6 = 0.469032645226*(xc6/(1.0 + xc6)**2)
C yb = xa / (1 + xa)**2
      yb0 = xa0 / xb0**2
      yb1 = xa1 / xb1**2
      yb2 = xa2 / xb2**2
